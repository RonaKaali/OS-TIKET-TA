...
(function() {
    try {
        ...
        var role = window.csirtTourRole;
        var page = window.csirtTourPage || 'default';
        var storageKey = 'csirt_tour_completed_' + role + '_' + page;
        ...
        function getSteps(role, page) {
            ...
            case 'agent|dashboard':
                return [
                    ...
                    { title: '📊 Kartu Statistik', text: '<strong>"Ditugaskan"</strong>: tiket aktif yang harus Anda kerjakan. <strong>"Dalam Proses"</strong>: sedang dikerjakan. <strong>"Selesai"</strong>: sudah ditutup. <strong>"Surat Tugas Baru"</strong>: tugas yang belum dikonfirmasi.', attachTo: { element: '#tour-agent-stats', on: 'bottom' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: 'Selanjutnya →', classes: 'shepherd-button-primary', action: function() { this.next(); } }] },
                    { title: '📋 Tugas Aktif Saya', text: 'Di bawah statistik ada <strong>daftar tiket</strong> yang harus Anda tangani dalam bentuk kartu. Klik kartu untuk melihat <strong>detail, merespon, dan menyelesaikan</strong>.', attachTo: { element: '#tour-agent-tasks', on: 'top' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: 'Selanjutnya →', classes: 'shepherd-button-primary', action: function() { this.next(); } }] },
                    { title: '🔔 Notifikasi', text: 'Bell notifikasi menampilkan <strong>tugas baru</strong> yang masuk. Angka merah menunjukkan jumlah tugas baru.', attachTo: { element: '#tour-notification', on: 'bottom' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: 'Selanjutnya →', classes: 'shepherd-button-primary', action: function() { this.next(); } }] },
                    { title: '🧭 Navigasi', text: '<strong>"Dashboard"</strong> untuk halaman ini. <strong>"Tutorial"</strong> untuk mengulang panduan ini.', attachTo: { element: '#tour-nav', on: 'bottom' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: ' Selesai ✓', classes: 'shepherd-button-primary', action: function() { this.complete(); } }] }
                ];
            ...
            case 'agent|ticket-show':
                return [
                    { title: '📄 Detail Tiket', text: 'Halaman ini berisi <strong>seluruh informasi</strong> insiden siber yang ditugaskan kepada Anda.', attachTo: { element: '#tour-surat-tugas', on: 'bottom' }, buttons: [{ text: ' Lewati', classes: 'csirt-skip', action: function() { this.cancel(); } }, { text: ' Mulai →', classes: 'shepherd-button-primary', action: function() { this.next(); } }] },
                    ...
                    { title: '💬 Balasan & Kronologi', text: 'Gulir ke bawah untuk melihat <strong>kronologi percakapan</strong> dengan pelapor. Kirim respon via form balasan.', attachTo: { element: '#tour-reply-form', on: 'top' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: 'Selanjutnya →', classes: 'shepherd-button-primary', action: function() { this.next(); } }] },
                    { title: '⚡ Aksi Tiket', text: 'Panel di sidebar untuk <strong>mengubah status</strong> tiket. Pilih status baru lalu klik "Konfirmasi Perubahan".', attachTo: { element: '#tour-aksi-tiket', on: 'left' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: 'Selesai ✓', classes: 'shepherd-button-primary', action: function() { this.complete(); } }] }
                ];
            ...
            case 'super-admin|dashboard':
                return [
                    ...
                    { title: '📈 Analitik Insiden', text: 'Grafik <strong>Trend Bulanan</strong> menampilkan data laporan selesai vs insiden kritis. Gunakan untuk <strong>analisis pola serangan</strong>.', attachTo: { element: '#tour-sa-chart', on: 'bottom' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: 'Selanjutnya →', classes: 'shepherd-button-primary', action: function() { this.next(); } }] },
                    { title: '🛡️ Zero Trust Security', text: 'Klik tombol ini untuk masuk ke <strong>Ruang Zero Trust</strong> — panel keamanan lanjutan.', attachTo: { element: '#tour-sa-zerotrust', on: 'bottom' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: 'Selanjutnya →', classes: 'shepherd-button-primary', action: function() { this.next(); } }] },
                    { title: '🔴 Global Threat Intel', text: 'Panel kanan menampilkan <strong>berita ancaman siber global</strong> secara real-time.', attachTo: { element: '#tour-sa-news', on: 'left' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: 'Selanjutnya →', classes: 'shepherd-button-primary', action: function() { this.next(); } }] },
                    { title: '🧭 Navigasi', text: '<strong>Dashboard</strong>: halaman ini. <strong>Tiket Laporan</strong>: daftar semua tiket. <strong>Panel Admin</strong>: pengelolaan pengguna. <strong>Zero Trust</strong>: keamanan.', attachTo: { element: '#tour-nav', on: 'bottom' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: ' Selesai ✓', classes: 'shepherd-button-primary', action: function() { this.complete(); } }] }
                ];
            ...
            case 'admin|dashboard':
                return [
                    ...
                    { title: '🎯 Cara Menugaskan Analis', text: 'Klik "Tugaskan Agen" → Di halaman detail, pilih analis → Pilih urgensi → Klik "Tugaskan Analis".', attachTo: { element: '#tour-admin-assign', on: 'top' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: 'Selanjutnya →', classes: 'shepherd-button-primary', action: function() { this.next(); } }] },
                    { title: '📋 Semua Tiket', text: 'Klik tombol ini untuk melihat <strong>daftar lengkap semua tiket</strong>.', attachTo: { element: '#tour-admin-alltickets', on: 'bottom' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: ' Selesai ✓', classes: 'shepherd-button-primary', action: function() { this.complete(); } }] }
                ];
            ...
            case 'admin|ticket-show':
                return [
                    ...
                    { title: '📋 Surat Tugas', text: 'Informasi lengkap insiden: <strong>nomor tiket, departemen, prioritas, analis, dan deadline</strong>.', attachTo: { element: '#tour-surat-tugas', on: 'bottom' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: 'Selanjutnya →', classes: 'shepherd-button-primary', action: function() { this.next(); } }] },
                    { title: '👥 Penugasan Analis', text: 'Panel ini <strong>hanya muncul untuk Admin</strong>. Pilih analis dari dropdown, atur urgensi, lalu klik "Tugaskan Analis".', attachTo: { element: '#tour-penugasan', on: 'left' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: 'Selanjutnya →', classes: 'shepherd-button-primary', action: function() { this.next(); } }] },
                    { title: '🔄 Kembalikan ke Super Admin', text: 'Jika tiket perlu eskalasi, klik tombol ini untuk <strong>mengembalikan ke Super Admin</strong>.', attachTo: { element: '#tour-aksi-tiket', on: 'left' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: 'Selesai ✓', classes: 'shepherd-button-primary', action: function() { this.complete(); } }] }
                ];
        ...
        function startTour() {
            try {
                if (window._csirtTour) {
                    ...
                    document.querySelectorAll('.shepherd-element, .shepherd-modal-overlay-container').forEach(function(el) { el.remove(); });
                }

                var steps = getSteps(role, page);
                ...
                console.error('CSIRT Tour Error:', err);
            }
        }
