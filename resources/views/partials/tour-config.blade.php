    ...
    function getSteps(role, page) {
        ...
        case 'super-admin|dashboard':
            return [
                ...
                { title: '🧭 Navigasi', text: '<strong>Dashboard</strong>: halaman ini. <strong>Tiket Laporan</strong>: daftar semua tiket. <strong>Panel Admin</strong>: pengelolaan pengguna & departemen. <strong>Zero Trust</strong>: keamanan.', attachTo: { element: '#tour-nav', on: 'bottom' }, buttons: [{ text: '← Kembali', action: function() { this.back(); } }, { text: ' Selesai ✓', classes: 'shepherd-button-primary', action: function() { this.complete(); } }] }
            ];
