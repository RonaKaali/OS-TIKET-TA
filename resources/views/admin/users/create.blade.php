                ...
                <div class="rounded-2xl border border-amber-200 bg-amber-50/70 p-5 dark:border-amber-500/20 dark:bg-amber-500/5">
                    <label for="allow_after_hours_access" class="flex cursor-pointer items-start gap-4">
                        <input type="checkbox" name="allow_after_hours_access" id="allow_after_hours_access" value="1"
                            {{ old('allow_after_hours_access') ? 'checked' : '' }}
                            class="peer sr-only">
                        ...
                        <span>
                            ...
                            <span class="mt-1 block text-[10px] font-bold leading-relaxed text-slate-500 dark:text-slate-400">Pengecualian keamanan untuk petugas piket atau kebutuhan darurat. Biarkan nonaktif untuk kebijakan standar.</span>
                        </span>
                    </label>
                </div>
