    ...
    <div class="min-h-screen bg-slate-50 dark:bg-slate-950 cyber-grid relative overflow-hidden transition-colors">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 relative z-10">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
                ...
                <!-- Overdue -->
                <div class="glass-card rounded-2xl p-5 sm:p-6 stat-glow-red transform hover:-translate-y-1 transition-all duration-300 animate-fade-in-up" style="animation-delay: 0.3s">
                    <div class="flex items-center justify-between mb-3">
                        <div class="w-10 h-10 bg-red-50 dark:bg-red-500/20 border border-red-200 dark:border-red-500/50 rounded-xl flex items-center justify-center transition-colors">
                            <svg class="w-5 h-5 text-red-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                            </svg>
                        </div>
                    </div>
                    <p class="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white animate-count-up transition-colors">{{ $overdueReports }}</p>
                    <p class="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mt-1 transition-colors">Kritis</p>
                </div>
            </div>
