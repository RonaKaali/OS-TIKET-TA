            ...
            <div class="glass-card rounded-3xl p-8 sm:p-10 shadow-2xl">
                <form method="POST" action="{{ route('portal.ticket.store') }}" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div x-data="{ 
                        ...
                        <p class="text-[10px] font-bold text-emerald-600 dark:text-emerald-500 uppercase tracking-widest mb-4 ml-1 flex items-center space-x-2">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
                            <span>Dilindungi Enkripsi AES-256 — File Anda akan dienkripsi sebelum disimpan</span>
                        </p>
                        <div
